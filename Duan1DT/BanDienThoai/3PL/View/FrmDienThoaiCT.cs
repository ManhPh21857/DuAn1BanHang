...
namespace _3PL.View
{
    public partial class FrmDienThoaiCT : Form
    {
        ...
        {
            InitializeComponent();
            foreach (var item in _DTService.GetAll())
            {
            ...
            foreach (var item in _ImeiService.GetAll())
            {
                cbb_Imei.Items.Add(item.TenImei);
            }
            foreach (var item in _DungLuongService.GetAll())
            {
                cbb_dungluong.Items.Add(item.SoDungLuong);
            }
            foreach (var item in _HSXService.GetAll())
            {
        ...
        public void Loadtodata()
        {
            ...
            dtg_show.Columns[0].Name = "Ma QR";
            dtg_show.Columns[1].Name = "Imei SP";
            dtg_show.Columns[2].Name = "Tên SP";
            dtg_show.Columns[3].Name = "Hãng SP";
            dtg_show.Columns[4].Name = "Mau Sac SP";
            dtg_show.Columns[5].Name = "Dung Luong SP";
            ...
            {
                dtg_show.Rows.Add(item.dienThoaiCT.MaQR, item.imei.TenImei, item.dienThoai.TenDT, item.hangSX.TenHang, item.mauSac.TenMau, item.dungLuong.SoDungLuong, item.dienThoaiCT.SoLuong, item.dienThoaiCT.GiaNhap, item.dienThoaiCT.GiaBan, item.dienThoaiCT.LinkAnh, item.dienThoaiCT.MaDTCT);
            }
        }
        ...
        private void ptb_quetma_Click(object sender, EventArgs e)
        {
